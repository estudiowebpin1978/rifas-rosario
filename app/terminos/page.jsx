        ...
        <div className="bg-white rounded-2xl p-6 border border-[#EBEBEB] shadow-sm space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Eco Rifas es una plataforma de rifas online. Al participar en nuestras rifas, aceptas los siguientes terminos y condiciones.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Los pagos se realizan a traves de transferencia bancaria o Mercado Pago al alias proporcionado. 
